...
export default class EmailCapture extends Component {
    ...
    componentDidMount() {
        window.fbq("trackCustom", "emailModalOpened", {
            time: `${Date.now()}`
        });
        gtag('event', 'emailModalOpened', {
            'event_category': 'emailModalOpened',
    ...
    handleSubmit(event) {
        ...
        window.fbq("trackCustom", "emailSubmitted", {
            time: `${Date.now()}`
        });
        gtag('event', 'emailSubmitted', {
            'event_category': 'emailSubmitted',
            'event_label': `${Date.now()}`
        });
    }
