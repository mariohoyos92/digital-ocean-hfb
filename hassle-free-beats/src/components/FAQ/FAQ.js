...
const FAQ = () => (
  <div className="faq-container">
    ...
    <QuestionAnswer
      ...
      answer={`No you do not! We like to provide you with the opportunity to earn as much for yourself from yourself as possible. All you will ever have to pay us for is for the initial license.`}
    />
    <QuestionAnswer
